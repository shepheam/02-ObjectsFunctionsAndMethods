...
#            When you want to go to the next window because there is not a code that I know of that will make it go to the next window without clicking
#
